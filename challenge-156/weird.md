...
We first need to get the list of divisors of `$n` then iterate through these
divisors to find is they exist a subset whose sum of it elements equals `$n`.

### Prerequisite

1. Get the list of divisors.
